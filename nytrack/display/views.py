    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if 'output2' in context.keys():
                print "HERE OUTPUT 2"
                return render(request, 'display/datatables_output2.html', context)
            if 'output3' in context.keys():
                print "HERE OUTPUT 3"
                return render(request, 'display/datatables_output3.html', context)
            else:
                return render(request, 'display/datatables_output.html', context)
        ...
        if request.GET.get('page'):
            ...
            return render(request, 'display/datatables_form.html', context)
